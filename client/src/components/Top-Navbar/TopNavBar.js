  ...
  return (
    <Container className="background" fluid>
      <Row className="icon-row">
        <Col xs={12} md={3} lg={2} className="phone">
          <PhoneIcon />
        </Col>

        <Col xs={12} md={3} lg={3} className="email">
          <EmailIcon />
        </Col>

        <Col xs={12} md={3} lg={3} className="facebook icon">
          <Facebook />
        </Col>

        <Col xs={12} md={3} lg={3} className="instagram icon">
          <Instagram />
        </Col>
      </Row>
    </Container>
