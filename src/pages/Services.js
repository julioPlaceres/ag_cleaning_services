...
function Services() {
    return (
      <>
      <h1>Services</h1>
      <h3 style={{margin: "5%"}}>Here's a comprehensive list of what we offer:</h3>
      <p>
        
        <Container className="services-list" style={{border: "3px solid gray", background: "lightblue", fontSize: "24px", font: "Calibri bold", margin: "0%", padding: "5%" }}>
        <tbody>
        ...
        <tr>Closet, attic, garage, basement and cabinet cleaning/organization</tr>
